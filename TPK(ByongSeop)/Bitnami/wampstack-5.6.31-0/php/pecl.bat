@ECHO OFF                                                                                                     
									SET "PHP_PEAR_SYSCONF_DIR=C:\Users\aa\Documents\joooo\TPK(ByongSeop)\Bitnami\wampstack-5.6.31-0\php"
...
FOR %%x IN ("C:\Users\aa\Documents\joooo\TPK(ByongSeop)\Bitnami\wampstack-5.6.31-0\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\Users\aa\Documents\joooo\TPK(ByongSeop)\Bitnami\wampstack-5.6.31-0\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\Users\aa\Documents\joooo\TPK(ByongSeop)\Bitnami\wampstack-5.6.31-0\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\Users\aa\Documents\joooo\TPK(ByongSeop)\Bitnami\wampstack-5.6.31-0\php\php.exe"
GOTO :INSTALLED
